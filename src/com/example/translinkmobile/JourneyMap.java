...
public class JourneyMap extends Activity implements JSONRequest.NetworkListener {
	/**
	 * Draw a polyline on the map marking the from > to destination Include the
	 * user's position on this map
	 */
...
=======
	...
	private void requestPlan(String fromId, String destId) {
		...
		String urlString = "http://deco3801-010.uqcloud.net/journeyplan.php?fromLocId="
				+ Uri.encode(fromId) + "&destLocId=" + Uri.encode(destId);
>>>>>>> Making sure JourneyMap and JourneyPlanner
