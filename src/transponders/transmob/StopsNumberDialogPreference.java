...
*
*/
public class StopsNumberDialogPreference extends DialogPreference
{
	...
	public StopsNumberDialogPreference(Context context)
	{
		this(context, null);
	}
	 
	public StopsNumberDialogPreference(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	 
		// get attributes specified in XML
		TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.StopsNumberDialogPreference, 0, 0);
		try
		{
			setMinValue(a.getInteger(R.styleable.StopsNumberDialogPreference_min, DEFAULT_MIN_VALUE));
			setMaxValue(a.getInteger(R.styleable.StopsNumberDialogPreference_android_max, DEFAULT_MAX_VALUE));
		}
		finally
		{
			a.recycle();
		...
		// set layout
		setDialogLayoutResource(R.layout.stops_number_picker_dialog);
